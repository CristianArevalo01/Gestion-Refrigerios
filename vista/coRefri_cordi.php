...
<html lang="en">
    <head>
        ...
        <script src="java/main2.js" defer></script>
    ...
    <div class="p"><div class="" id="paginador"></div></div></div>
        ...
        <thead>
            <tr>
                ...
                <th style="width: 30px;">Id Coor</th>
                <th style="width: 30px;">Id Auxi</th>
                <th></th>
                <th></th>
            </tr>
        </thead>
            ...
            if ($Refrigerio!=null){
                ...
                ?>
                    <tr>
                        ...
                        <td class="celdas2" style="width: 1px"><?php echo $r['fecha']; ?></td>
                        <td class="celdas2" style="width: 3px"><?php echo $r['hora']; ?></td>
                        <td class="celdas2" style="width: 1px"><?php echo $r['tipo']; ?></td>
                        <td class="celdas2" style="width: 1px"><?php echo $r['cantidad']; ?></td>
                        <td class="celdas2" style="width: 1px"><?php echo $r['descripcion']; ?></td>
                        <td class="celdas2" style="width: 1px"><?php echo $r['estado']; ?></td>
                        <td class="celdas2" style="width: 2px"><?php echo $r['id_coordinador_fk']; ?></td>
                        <td class="celdas2" style="width: 2px"><?php echo $r['id_auxiliar_fk']; ?></td>
                
                        <td  style="width: 5px;" class="boton1">
                            <a class="bot" href="editRefri_cordi.php?id=<?php echo $r['id'];?>"><img src="assets/lapiz.svg" alt=""></a><!--indica que controlador y que accion ejecutar, en este caso llamaria al archivo editarusuario.php pasando el id como parametro--->
                        </td>
                        <td style="width: 20px;" class="boton2">
                            <a data-id ="<?php echo $r['id'];?>" data-estado="<?php echo $r['estado'];?>" class="lapiz"><img src="assets/basura.svg" a></a><!--indica que controlador y que accion ejecutar, en este caso llamaria al archivo eliminarusuario.php pasando el id como parametro--->
                        </td>
                    </tr>
                    <?php
                }
