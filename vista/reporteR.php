...
require('../Modelo/Refrigerios.php');
...
function header() 
{
    ...
    $this->Cell(50);
    //Titulo
    $this->Cell(90,10,'REPORTE DE REFRIGERIOS',1,0,'C');
    //Salto de linea
    $this->Ln(25);
}   
//Pie de pagina
...
$pdf->Cell(20,10,utf8_decode('hora'),1,0,'C',0);
$pdf->Cell(10,10,utf8_decode('tipo'),1,0,'C',0);
$pdf->Cell(17,10,utf8_decode('cantidad'),1,0,'C',0);
$pdf->Cell(70,10,utf8_decode('descripcion'),1,0,'C',0);
$pdf->Cell(20,10,utf8_decode('estado'),1,0,'C',0);
$pdf->Cell(15,10,utf8_decode('Id Coor'),1,0,'C',0);
$pdf->Cell(15,10,utf8_decode('Id Aux'),1,1,'C',0);
...
if ($Refrigerio!=null){
    foreach($Refrigerio as $r){
        ...
        $pdf->Cell(20,10,utf8_decode($r['fecha']),1,0,'C',0);
        $pdf->Cell(20,10,utf8_decode($r['hora']),1,0,'C',0);
        $pdf->Cell(10,10,utf8_decode($r['tipo']),1,0,'C',0);
        $pdf->Cell(17,10,utf8_decode($r['cantidad']),1,0,'C',0);
        $pdf->Cell(70,10,utf8_decode($r['descripcion']),1,0,'C',0);
        $pdf->Cell(20,10,utf8_decode($r['estado']),1,0,'C',0);
        $pdf->Cell(15,10,utf8_decode($r['id_coordinador_fk']),1,0,'C',0);
        $pdf->Cell(15,10,utf8_decode($r['id_auxiliar_fk']),1,1,'C',0);
    }
}
