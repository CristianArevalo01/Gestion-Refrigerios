    ...
    <div class="p"><div class="" id="paginador"></div></div></div>
        ...
        <thead>
            <tr>
                ...
                <th style="width: 60px;">Profesor</th>
        ...
        <tbody>
            ...
            if ($Curso!=null){
                ...
                ?>
                    <tr>
                    <td class="celdas2" style="width: 100px;"><?php echo $r['id']; ?></td>
                        <td class="celdas2" style="width: 200px;"><?php echo $r['cantidad']; ?></td>
                        <td class="celdas2" style="width: 200px;"><?php echo $r['profesor']; ?></td>
                        <td class="celdas2" style="width: 200px;"><?php echo $r['estado']; ?></td>
                        <td class="celdas2" style="width: 200px;"><?php echo $r['jornada']; ?></td>
                    </tr>
                    <?php
                }
            }
