...
function header() 
{
    ...
    $this->Cell(50);
    //Titulo
    $this->Cell(90,10,'REPORTE DE CURSOS',1,0,'C');
    //Salto de linea
    $this->Ln(25);
}   
//Pie de pagina
...
$pdf->Cell(50,10,utf8_decode('Cantidad'),1,0,'C',0);
$pdf->Cell(50,10,utf8_decode('Profesor'),1,0,'C',0);
$pdf->Cell(50,10,utf8_decode('Estado'),1,0,'C',0);
$pdf->Cell(30,10,utf8_decode('Jornada'),1,1,'C',0);
...
if ($Curso!=null){
    foreach($Curso as $r){
        $pdf->Cell(1);
        $pdf->Cell(10,10,utf8_decode($r['id']),1,0,'C',0);
        $pdf->Cell(50,10,utf8_decode($r['cantidad']),1,0,'C',0);
        $pdf->Cell(50,10,utf8_decode($r['profesor']),1,0,'C',0);
        $pdf->Cell(50,10,utf8_decode($r['estado']),1,0,'C',0);
        $pdf->Cell(30,10,utf8_decode($r['jornada']),1,1,'C',0);
    }
}
